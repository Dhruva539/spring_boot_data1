...
public class UserController {
	...
	@PutMapping(value="/addSalutation", headers="Accept=application/json")
	public ResponseEntity<String> addSalutation()
	{
		System.out.println("adding Salutation");
		userService.addSalutation();
		return new ResponseEntity<String>(HttpStatus.OK);
	}
